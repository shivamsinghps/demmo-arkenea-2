...
/**
 * Class CheckoutSubmitted
 */
class CheckoutSubmitted implements EventSubscriberInterface
{
    /** @var EngineInterface */
    private $parser;

    /**
     * CheckoutSubmitted constructor.
     ...
     * @return void
     */
    public function onCheckoutSubmitted(TransactionEvent $event)
    {
        if ($event->getTransaction()->getType() !== UserTransaction::TXN_BOOK_PURCHASE) {
            return;
        }

        $message = $this->parser->render("@DomainBundle/payment/checkout_submitted.html.twig", [
    ...
    {
        return [
            TransactionEvent::TRANSACTION_COMPLETED => "onCheckoutSubmitted"
        ];
    }
}
